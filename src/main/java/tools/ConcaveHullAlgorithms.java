 ...
 */
public class ConcaveHullAlgorithms {

    private Double euclideanDistance(Point a, Point b) {
        /*
        GlobalCoordinates opa = new GlobalCoordinates(a.getY(), a.getX());
        GlobalCoordinates opb = new GlobalCoordinates(b.getY(), b.getX());
        GeodeticCalculator geoCalc = new GeodeticCalculator();
        GeodeticCurve geoCurve = geoCalc.calculateGeodeticCurve(Configs.reference, opa, opb);
        */
    ...
    private Double calculateAngle(Point o1, Point o2) {
        /*
        GlobalCoordinates op1 = new GlobalCoordinates(o1.getY(), o1.getX());
        GlobalCoordinates op2 = new GlobalCoordinates(o2.getY(), o2.getX());
        GeodeticCalculator geoCalc = new GeodeticCalculator();
        GeodeticCurve geoCurve = geoCalc.calculateGeodeticCurve(Configs.reference, op1, op2);*/
    ...
    private Double angleDifference(Double a1, Double a2) {
        ...
        if ((a1 > 0 && a2 >= 0) && a1 > a2) {
            ...
            return 2D * Math.PI + a1 - a2;
        } else if ((a1 < 0 && a2 <= 0) && a1 < a2) {
            return 2D * Math.PI + a1 + Math.abs(a2);
        } else if ((a1 <= 0 && a2 < 0) && a1 > a2) {
            return Math.abs(a1 - a2);
        } else if (a1 <= 0 && 0 < a2) {
            return 2D * Math.PI + a1 - a2;
    ...
    public ConcaveHullAlgorithms() {

    }

    public ArrayList<Point> calculateConcaveHull(List<Point> pointArrayList, Integer k) {
